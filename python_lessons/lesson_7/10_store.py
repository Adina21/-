...
print(store[goods['Лампа']][0]['quantity'])
# или проще (/сложнее ?)
...
cost_table = table_cost + table_cost_1
print('стол -', table_quantity + table_quantity_1, 'шт, стоимость', cost_table, 'руб')
...
cost_chair = chair_cost + chair_cost1 + chair_cost2
quantity_chair = chair_quantity + chair_quantity1 + chair_quantity2
print('Стул-', quantity_chair, 'шт, стоимость', cost_chair, 'руб')
