TOKEN = '08f40a172bfb42d16aa749d0aebded802dc3663e2da1d4c7fd4bdf3ff9f0f60e28d5316206698d2d17082'
GROUP_ID = 192695670
...
SCENARIOS = {
    'registration': {
        ...
        'steps': {
            ...
            'step3': {
                'text': ' Спасибо за регистрацию, {name}! Мы отправила на  {email}  билет, распечатайте его.',
                'failure_text': None,
                'handler': None,
                'next_step': None
            },
