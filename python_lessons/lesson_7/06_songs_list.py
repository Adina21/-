...
x = violator_songs_list[3][1]+violator_songs_list[5][1]+violator_songs_list[8][1]
...
World = violator_songs_dict['World in My Eyes']
Policy = violator_songs_dict['Policy of Truth']
Blue = violator_songs_dict['Blue Dress']
result = World+Policy+Blue
print('А другие три песни звучат',result,'минут')
