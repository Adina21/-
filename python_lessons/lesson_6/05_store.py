...
#         подсчет стоимости товара#     вывод на консоль количества и стоимости товара на склад

for name, cod in goods.items():
    total_quantity = 0
    total_cost = 0
    for product_info in store[cod]:
        total_quantity += product_info['quantity']
        total_cost += product_info['quantity']*product_info['price']
    print(name, total_quantity, 'стоимость', total_cost)
